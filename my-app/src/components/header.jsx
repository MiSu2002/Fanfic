    ...
    return(
      ...
      <div className='row'>
        ...
        <div className='col'>
            ...
            <div className="heading">
      <div className='row'>
        <div className='col logo mb-2 mt-2 text-center'>Fanfic</div>
        <div className='col'>
            </div></div>
            </div></div>

            <div className='xl-img container-fluid p-0 d-none d-xl-block d-xxl-none'>
            <div className="heading">
      <div className='row'>
        <div className='col logo mb-2 mt-2 text-center'>Fanfic</div>
        <div className='col'>
            ...
            <div className='xxl-img container-fluid p-0 vh-100 d-none d-xxl-block'>
            <div className="heading">
      <div className='row'>
        <div className='col logo mb-2 mt-2 text-center'>Fanfic</div>
        <div className='col'>
